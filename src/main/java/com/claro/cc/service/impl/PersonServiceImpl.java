...
public class PersonServiceImpl implements PersonService {
    ...
    public PersonServiceImpl(PersonRepository personRepository, PersonMapper personMapper, PersonFullMapper personFullMapper) {
    ...
    public Optional<PersonDTO> findOne(Long id) {
        ...
        return personRepository.findById(id)
            .map(personFullMapper::personToPersonFullDTO);
    }
