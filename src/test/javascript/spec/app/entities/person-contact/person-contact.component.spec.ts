...
import { PersonContactComponent } from 'app/entities/person-contact/person-contact.component';
...
describe('Component Tests', () => {
    describe('PersonContact Management Component', () => {
        let comp: PersonContactComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PersonContactComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.personContacts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
